...
{
    public class SqadXlsxSheetBuilder : SqadXlsxSheetBuilderBase
    {
        ...
        public SqadXlsxSheetBuilder(string sheetName, bool isReferenceSheet = false, bool isPreservationSheet = false, bool isHidden = false)
