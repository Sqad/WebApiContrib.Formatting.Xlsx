...
namespace SQAD.XlsxExportImport.Base.Interfaces
{
    ...
    public interface IXlsxSerialiser
    {
       ...
       // bool IgnoreFormatting { get; }
        ...
        void Serialise(Type itemType, object value, IXlsxDocumentBuilder document, string sheetName, string columnPrefix, SqadXlsxSheetBuilder sheetbuilderOverride);
